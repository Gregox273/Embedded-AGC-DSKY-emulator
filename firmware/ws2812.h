...
// mask and addresses may be the same.
  ...
  #define ws2812_port_clr ((uint32_t*)&GPIOC->BSRR) // Address of the data port register to clear the pin

  #define ws2812_mask_set  1<<GPIOC_LED_DIN        // Bitmask to set the data out pin
  #define ws2812_mask_clr  1<<(GPIOC_LED_DIN+16)   // Bitmask to clear the data out pin
#endif
///////////////////////////////////////////////////////////////////////
...
#define ws2812_cpuclk STM32_HCLK
