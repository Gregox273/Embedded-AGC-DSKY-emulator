...
OBJS      := $(ASMXOBJS) $(ASMOBJS) $(ACOBJS) $(TCOBJS) $(ACPPOBJS) $(TCPPOBJS) $(OBJDIR)/Luminary099Transcoded.o
...
$(OBJDIR)/Luminary099Transcoded.o:
	$(TRGT)ld -r -b binary Luminary099Transcoded.bin -o $(OBJDIR)/Luminary099Transcoded.o
	$(TRGT)objcopy --rename-section .data=.rodata,alloc,load,readonly,data,contents $(OBJDIR)/Luminary099Transcoded.o $(OBJDIR)/Luminary099Transcoded.o
